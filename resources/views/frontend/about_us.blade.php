...
@section('content')
    <main>
        ...
        <div class="row row--g-20 align-items-center justify-content-between">
            <div class="col-lg-12">
                <h2 class="headline-1 letters js-wordsplit">Our <span class="color-gold"> Values</span>
                </h2>
                <div class="content one-col-indent">
                    <p>Our values run through the core of our team and are reflected in the way we work with our discerning clientele, with Helpfulness, Respect and Humility.</p>
                    <p>
                    <span class="color-gold">
                        <strong>H.R.H - HIS ROYAL HIGHNESS <br />
                        </strong>
                    </span>We Treat Everyone Like Royalty
                    </p>
                    <p>
                    <a class="btn btn--bordered btn--bordered-gold" href="/our-team">Our team</a>
                    </p>
                </div>
            </div>
        </div>
